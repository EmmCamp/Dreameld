                ...
                <div className="md:flex justify-center">
                    <div className="lg:w-2/6 md:w-2/4 relative overflow-hidden bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                        <div className="p-6">
                            ...
                            <h5 className="my-6 text-xl font-medium">Login</h5>
                            <form className="text-start">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="text-center">
                                        <span className="text-slate-400 me-2">Don't have an account ?</span> <Link to="/signup" className="text-slate-900 dark:text-white font-medium">Sign Up</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
