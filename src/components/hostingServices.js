            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                {serviceData2.map((item,index) => {
                   ...
                   return(
                    <div key={index}>
                        {bgIcon === true ?  
                            <div key={index} className="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-gray-700 hover:bg-violet-500 dark:hover:bg-emerald-500 transition-all duration-500 ease-in-out rounded-md bg-slate-50 dark:bg-slate-800 hover:scale-[1.02] overflow-hidden">
                                <Icon className="text-[36px] text-emerald-500 group-hover:text-white/70 duration-500"/>
                                <div className="mt-6">
                            ...
                            <div key={index} className="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-violet-500 dark:hover:bg-emerald-500 transition-all duration-500 ease-in-out rounded-md bg-white dark:bg-slate-900 overflow-hidden">
