                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                    ...
                    <div className="lg:col-span-6 md:order-1 order-2">
                        ...
                        <ul className="list-none text-slate-400 mt-4">
                            <li className="mb-1 flex"><AiOutlineCheckCircle className="text-sky-500 text-xl me-2"/>Soluciones tecnológicas para negocios modernos</li>
                            <li className="mb-1 flex"><AiOutlineCheckCircle className="text-sky-500 text-xl me-2"/>Soporte especializado y acompañamiento continuo</li>
                            <li className="mb-1 flex"><AiOutlineCheckCircle className="text-sky-500 text-xl me-2"/>Infraestructura flexible adaptada a tu crecimiento</li>
                        </ul>
