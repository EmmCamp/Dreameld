...
import {FiArrowUp,HiOutlineMoon,HiOutlineSun,AiOutlineArrowUp} from "../assets/icons/vander"
...
export default function Switcher() {
    ...
    return (
        <>
            ...
            <div className="fixed top-1/2 -right-3 z-50">
            ...
            <Link to="#" onClick={scrollToTop}  id="back-to-top" className={`${scrollTop ? 'back-to-top fixed flex items-center  justify-center text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-sky-500 text-white leading-9':'none'} `}><AiOutlineArrowUp/></Link>
