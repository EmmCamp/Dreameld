                                ...
                                {/*<div className="group p-6 relative overflow-hidden shadow-lg dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
                                    ...
                                    <div className="group p-6 relative overflow-hidden shadow-lg dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <ul className="list-none text-slate-400">
                                            ...
                                            <li className="mb-1 flex items-start"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 me-2 mt-1"/> <span>Certificado SSL <strong className="font-extrabold text-black dark:text-white">Gratis</strong></span></li>
                                            ...
                                            <li className="mb-1 flex items-start"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 me-2 mt-1"/> <span>Soporte por <strong className="font-extrabold text-black dark:text-white">WhatsApp&nbsp;</strong></span></li>
                                        </ul>
                                        <Link to="" className="inline-block px-8 py-2.5 text-[16px] font-medium tracking-wide bg-transparent hover:bg-violet-500 border border-gray-100 dark:border-gray-800 dark:hover:bg-emerald-500 hover:border-violet-500 dark:hover:border-emerald-500 text-slate-900 dark:text-white hover:text-white focus:ring-[3px] focus:ring-violet-500 focus:ring-opacity-25 focus:outline-none rounded-md text-center align-middle transition-all duration-500 w-full mt-5">Contáctanos</Link>
                                    </div>
                                    ...
                                    <div className="group p-6 relative overflow-hidden shadow-lg dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <ul className="list-none text-slate-400">
                                            ...
                                            <li className="mb-1 flex"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 align-middle me-2"/> <span className="">Panel de control cPanel</span></li>
                                            <li className="mb-1 flex items-start"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 me-2 mt-1"/> <span>Soporte por WhatsApp <strong className="font-extrabold text-black dark:text-white">(Prioritario)</strong></span></li>
                                        </ul>
                                        <Link to="" className="inline-block px-8 py-2.5 text-[16px] font-medium tracking-wide bg-transparent hover:bg-violet-500 border border-gray-100 dark:border-gray-800 dark:hover:bg-emerald-500 hover:border-violet-500 dark:hover:border-emerald-500 text-slate-900 dark:text-white hover:text-white focus:ring-[3px] focus:ring-violet-500 focus:ring-opacity-25 focus:outline-none rounded-md text-center align-middle transition-all duration-500 w-full mt-5">Contáctanos</Link>
                                    </div>
                                    ...
                                    <div className="group relative overflow-hidden shadow-lg dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <ul className="list-none text-slate-400">
                                                ...
                                                <li className="mb-1 flex items-start"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 me-2 mt-1"/> <span>Crea tu Web a Clics <strong className="font-extrabold text-black dark:text-white">(SiteJet)</strong></span></li>
                                                <li className="mb-1 flex"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 align-middle me-2"/> <span className="">Panel de control cPanel</span></li>
                                                <li className="mb-1 flex items-start"><AiOutlineCheckCircle className="text-violet-600 text-[20px] shrink-0 me-2 mt-1"/> <span>Soporte por WhatsApp <strong className="font-extrabold text-black dark:text-white">(Prioritario 24/7)</strong></span></li>
                                            </ul>
                                            <Link to="" className="inline-block px-8 py-2.5 text-[16px] font-medium tracking-wide bg-violet-500 hover:bg-emerald-500 border border-violet-500 hover:border-emerald-500 text-white focus:ring-[3px] focus:ring-emerald-500 focus:ring-opacity-25 focus:outline-none rounded-md text-center align-middle transition-all duration-500 w-full mt-5">Contáctanos</Link>
